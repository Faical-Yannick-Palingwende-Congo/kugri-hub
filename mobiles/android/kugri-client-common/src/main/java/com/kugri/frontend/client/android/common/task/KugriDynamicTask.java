 ...
 */
public class KugriDynamicTask extends AbstractDynamicTask{
	 ...
	 */
	public KugriDynamicTask(long wait, int timeout) {
		super(wait, timeout, false);
	}
	...
	public AbstractResponse executer(DefaultHttpClient httpClient,
		...
		try {
		    ...
		    Context.LOGGER.pushErrors(e, "KugriDynamicTask - UnsupportedEncodingException: " + Log.getStackTraceString(e));
		}
		...
		try {
		    ...
		    if (httpEntity != null) {
		        ...
		        if(metapart.length == 1){
				    ...
				    Context.LOGGER.pushInfos("KugriDynamicTask - Result: " + result);
		        	...
		        	Context.LOGGER.pushErrors(new Exception(), "KugriDynamicTask - Weird envelope.");
		        }
		    }
		} catch (ClientProtocolException e) {
		    Context.LOGGER.pushErrors(e, "KugriDynamicTask - ClientProtocolException: " + Log.getStackTraceString(e));
		} catch (IOException e) {
		    Context.LOGGER.pushErrors(e, "KugriDynamicTask - IOException: " + Log.getStackTraceString(e));
		} catch (JSONException e) {
			Context.LOGGER.pushErrors(e, "KugriDynamicTask - JSONException: " + Log.getStackTraceString(e));
		}
