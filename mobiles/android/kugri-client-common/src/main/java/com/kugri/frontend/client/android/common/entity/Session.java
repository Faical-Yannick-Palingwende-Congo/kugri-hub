...
/* Class            : Session                                                                  */
/*                                                                                             */
/* Description      : Session class for loading the session entity instances.                  */
/*                                                                                             */
/* Author           : FYPC                                                                     */
...
public class Session {
	 ...
	 */
	public Session(String id, String account, String stamp, String access, String status) {
		super();
		this.id = id;
	 ...
	 * @param status the session instance status
	 */
	public Session(String id, String account, String status) {
		super();
		this.id = id;
		this.account = account;
		this.status = status;
