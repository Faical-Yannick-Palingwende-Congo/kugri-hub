 ...
 */
public abstract class KugriRequestableTask extends AbstractDynamicTask{
	 ...
	 */
	public KugriRequestableTask(long wait, int timeout) {
		super(wait, timeout, true);
	}
	...
	public AbstractResponse executer(DefaultHttpClient httpClient) {
		...
		try {
			...
			Context.LOGGER.pushErrors(e, "KugriRequestableTask - UnsupportedEncodingException: " + Log.getStackTraceString(e));
		}
		...
		try {
		    ...
		    if (httpEntity != null) {
		        ...
		        if(metapart.length == 1){
				    ...
				    Context.LOGGER.pushInfos("KugriRequestableTask - Result: " + result);
		        	...
		        	Context.LOGGER.pushErrors(new Exception(), "KugriRequestableTask - Weird envelope.");
		        }
		    }
		} catch (ClientProtocolException e) {
		    Context.LOGGER.pushErrors(e, "KugriRequestableTask - ClientProtocolException: " + Log.getStackTraceString(e));
		} catch (IOException e) {
		    Context.LOGGER.pushErrors(e, "KugriRequestableTask - IOException: " + Log.getStackTraceString(e));
		} catch (JSONException e) {
			Context.LOGGER.pushErrors(e, "KugriRequestableTask - JSONException: " + Log.getStackTraceString(e));
		}
