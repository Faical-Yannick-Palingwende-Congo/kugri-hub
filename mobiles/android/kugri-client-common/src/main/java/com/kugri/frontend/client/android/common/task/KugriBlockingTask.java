 ...
 */
public class KugriBlockingTask extends AbstractBlockingTask{
	 ...
	 */
	public KugriBlockingTask(int timeout) {
		super(timeout);
	}
	...
	public AbstractResponse executer(DefaultHttpClient httpClient,
		...
		try {
		    ...
		    Context.LOGGER.pushErrors(e, "KugriBlockingTask - UnsupportedEncodingException: " + Log.getStackTraceString(e));
		}
		...
		try {
		    ...
		    if (httpEntity != null) {
		        ...
		        if(metapart.length == 1){
				    ...
				    Context.LOGGER.pushInfos("KugriBlockingTask - Result: " + result);
		        	...
		        	Context.LOGGER.pushErrors(new Exception(), "KugriBlockingTask - Weird envelope.");
		        }
		    }
		} catch (ClientProtocolException e) {
		    Context.LOGGER.pushErrors(e, "KugriBlockingTask - ClientProtocolException: " + Log.getStackTraceString(e));
		} catch (IOException e) {
		    Context.LOGGER.pushErrors(e, "KugriBlockingTask - IOException: " + Log.getStackTraceString(e));
		} catch (JSONException e) {
			Context.LOGGER.pushErrors(e, "KugriBlockingTask - JSONException: " + Log.getStackTraceString(e));
		}
