...
/*=============================================================================================*/
package com.kugri.frontend.client.android.helloworld.utils;
...
public class Logger {
	...
	public DateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy [HH:mm:ss:SSS]",Locale.US);
	...
	public void pushInfos(String details) {
		...
		this.infos.add("<<<<" + this.dateFormat.format(date)
				+ " ### GREEN - Logging Infos: " + details);
		Log.i(Context.TAG, "<<<<" + this.dateFormat.format(date)
				+ " ### GREEN - Logging Infos: " + details);
		this.infosNumber++;
	}
	...
	public void pushWarnings(Exception exception, String details) {
		...
		this.warnings.add("<<<<" + this.dateFormat.format(date)
				+ " ### YELLOW - Logging Warnings: " + details
				+ " Exception: " + exception.getClass());
		Log.w(Context.TAG, "<<<<" + this.dateFormat.format(date)
				+ " ### YELLOW - Logging Warnings: " + details
				+ " Exception: " + exception.getClass());
		this.warningsNumber++;
	}
	...
	public void pushErrors(Exception exception, String details) {
		...
		this.errors.add("<<<<" + this.dateFormat.format(date)
				+ " ### RED - Logging Errors: " + details
				+ " Exception: " + exception.getClass());
		Log.e(Context.TAG, "<<<<" + this.dateFormat.format(date)
				+ " ### RED - Logging Errors: " + details
				+ " Exception: " + exception.getClass());
		this.errorsNumber++;
	}
	...
	public void pushDebugs(String details) {
		...
		this.debugs.add("<<<<" + this.dateFormat.format(date)
				+ " ### BLUE - Logging Debugs: " + details);
		Log.d(Context.TAG, "<<<<" + this.dateFormat.format(date)
				+ " ### BLUE - Logging Debugs: " + details);
		this.debugsNumber++;
	}
